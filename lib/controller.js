...
// modified from egg-core/lib/loader/mixin/contrller.js
...
module.exports = {
  ...
  loadController(opt) {
    opt = Object.assign({
      ...
      initializer: (obj, opt) => {
        ...
        if (is.promise(obj)) {
          ...
          const displayPath = path.relative(this.appDir, opt.path);
    ...
    const controllerBase = path.join(this.appDir, 'app/controller');
